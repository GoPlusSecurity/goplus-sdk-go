...
// ContextValidate validates this contract approve response based on context it is used
func (m *ContractApproveResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
