...
func (m *ResponseWrapperTokenLockerResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTokenLockerResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTokenLockerResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTokenLockerResponse
