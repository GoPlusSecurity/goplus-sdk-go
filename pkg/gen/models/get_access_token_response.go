...
// ContextValidate validates this get access token response based on context it is used
func (m *GetAccessTokenResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
