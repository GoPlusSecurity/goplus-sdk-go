...
func (m *ResponseWrapperNftLockerResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperNftLockerResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ResponseWrapperNftLockerResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperNftLockerResponse
