...
// ResponseWrapperTaTokenSecurityResponse ResponseWrapper«TaTokenSecurityResponse»
//
// swagger:model ResponseWrapper«TaTokenSecurityResponse»
...
// ContextValidate validate this response wrapper ta token security response based on the context it is used
func (m *ResponseWrapperTaTokenSecurityResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTaTokenSecurityResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
