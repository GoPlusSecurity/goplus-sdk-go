...
func (m *ResponseWrapperTransactionSecurityResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTransactionSecurityResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTransactionSecurityResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTransactionSecurityResponse
