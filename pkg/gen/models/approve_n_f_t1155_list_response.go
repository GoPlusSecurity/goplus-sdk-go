...
func (m *ApproveNFT1155ListResponse) validateApprovedList(formats strfmt.Registry) error {
...
// ContextValidate validate this approve n f t1155 list response based on the context it is used
func (m *ApproveNFT1155ListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ApproveNFT1155ListResponse) contextValidateApprovedList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApproveNFT1155ListResponse) UnmarshalBinary(b []byte) error {
	var res ApproveNFT1155ListResponse
