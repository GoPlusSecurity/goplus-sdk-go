...
// ContextValidate validates this audit info based on context it is used
func (m *AuditInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
