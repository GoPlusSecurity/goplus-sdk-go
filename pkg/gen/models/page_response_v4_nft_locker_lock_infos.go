...
func (m *PageResponseV4NftLockerLockInfos) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageResponseV4NftLockerLockInfos) validateList(formats strfmt.Registry) error {
...
func (m *PageResponseV4NftLockerLockInfos) UnmarshalBinary(b []byte) error {
	var res PageResponseV4NftLockerLockInfos
