...
func (m *ResponseWrapperOpenScanAddressResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperOpenScanAddressResp) validateResult(formats strfmt.Registry) error {
...
func (m *ResponseWrapperOpenScanAddressResp) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperOpenScanAddressResp
