...
// NewAddressNFT1155ApproveListUsingGET1Params creates a new AddressNFT1155ApproveListUsingGET1Params object,
...
func NewAddressNFT1155ApproveListUsingGET1Params() *AddressNFT1155ApproveListUsingGET1Params {
	return &AddressNFT1155ApproveListUsingGET1Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewAddressNFT1155ApproveListUsingGET1ParamsWithTimeout creates a new AddressNFT1155ApproveListUsingGET1Params object
...
// NewAddressNFT1155ApproveListUsingGET1ParamsWithContext creates a new AddressNFT1155ApproveListUsingGET1Params object
...
// NewAddressNFT1155ApproveListUsingGET1ParamsWithHTTPClient creates a new AddressNFT1155ApproveListUsingGET1Params object
...
/*
AddressNFT1155ApproveListUsingGET1Params contains all the parameters to send to the API endpoint

	for the address n f t1155 approve list using g e t 1 operation.
...
// WithDefaults hydrates default values in the address n f t1155 approve list using g e t 1 params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AddressNFT1155ApproveListUsingGET1Params) WithDefaults() *AddressNFT1155ApproveListUsingGET1Params {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the address n f t1155 approve list using g e t 1 params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AddressNFT1155ApproveListUsingGET1Params) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the address n f t1155 approve list using g e t 1 params
func (o *AddressNFT1155ApproveListUsingGET1Params) WithTimeout(timeout time.Duration) *AddressNFT1155ApproveListUsingGET1Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the address n f t1155 approve list using g e t 1 params
func (o *AddressNFT1155ApproveListUsingGET1Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the address n f t1155 approve list using g e t 1 params
func (o *AddressNFT1155ApproveListUsingGET1Params) WithContext(ctx context.Context) *AddressNFT1155ApproveListUsingGET1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the address n f t1155 approve list using g e t 1 params
func (o *AddressNFT1155ApproveListUsingGET1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the address n f t1155 approve list using g e t 1 params
func (o *AddressNFT1155ApproveListUsingGET1Params) WithHTTPClient(client *http.Client) *AddressNFT1155ApproveListUsingGET1Params {
...
func (o *AddressNFT1155ApproveListUsingGET1Params) WithAuthorization(authorization *string) *AddressNFT1155ApproveListUsingGET1Params {
...
func (o *AddressNFT1155ApproveListUsingGET1Params) WithAddresses(addresses string) *AddressNFT1155ApproveListUsingGET1Params {
...
func (o *AddressNFT1155ApproveListUsingGET1Params) WithChainID(chainID string) *AddressNFT1155ApproveListUsingGET1Params {
...
func (o *AddressNFT1155ApproveListUsingGET1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
