...
/*
PhishingSiteUsingGETOK describes a response with status code 200, with default header values.
...
/*
PhishingSiteUsingGETUnauthorized describes a response with status code 401, with default header values.
...
/*
PhishingSiteUsingGETForbidden describes a response with status code 403, with default header values.
...
/*
PhishingSiteUsingGETNotFound describes a response with status code 404, with default header values.
